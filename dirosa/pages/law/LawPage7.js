...
export default class LawPage7 extends Component {
    ...
    return(
      <Container>
        <Header style={{ backgroundColor: '#1B5A07' }}>
          ...
          <Body>
            <Title style={styles.titleHeader}>HUKUM IQLAB</Title>
          </Body>
        </Header>

        <Content style={styles.wrapIndex}>
          <View>
            <Text style={styles.titleContent}>Iqlab</Text>
          ...
          <View style={styles.video}>
            ...
            <WebView
              style={{flex:1}}
              source={{uri: 'https://www.youtube.com/watch?v=5hjpzR3uHio'}}
            />
          </View>
        </Content>
      </Container>
