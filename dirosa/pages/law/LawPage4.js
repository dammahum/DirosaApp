...
export default class LawPage4 extends Component {
    ...
    return(
      <Container>
        <Header style={{ backgroundColor: '#1B5A07' }}>
          ...
          <Body>
            <Title style={styles.titleHeader}>HUKUM IZHAR</Title>
          </Body>
        </Header>

        <Content style={styles.wrapIndex}>
          <View>
            <Text style={styles.titleContent}>Izhar</Text>
          ...
          <View style={styles.video}>
            ...
            <WebView
              style={{flex:1}}
              source={{uri: 'https://www.youtube.com/watch?v=te9scAs8VGM&t=227s'}}
            />
          </View>
        </Content>
      </Container>
